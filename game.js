...
function playSequence() {
  ...
  sequence.forEach((clr, i) => {
    // each flash delayed by i × 1050 ms
    setTimeout(() => flash(clr), i * 1050);
    //I made the delay longer to make the game easier 
...
function handleClick(chosen) {
  if (chosen === sequence[playerPos]) {
    ...
    alert("You Lose!!!!! Next Round: " + sequence.length);
    //I changed the alert to this because I think mine makes it a little comical. 
    resetGame();
  }
}
